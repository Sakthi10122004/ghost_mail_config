import { u as k, j as e } from "./index-By5yPnMZ.mjs";
import { g as N, B as a, l as w } from "./heading-DXxLDQ96.mjs";
import { g as C, h as y, i as z, X as M, j as H, k as $, l as P, m as D, C as I } from "./dialog-67vvNv8e.mjs";
/**
...
const S = [
  ...
  }, h = encodeURIComponent(l), r = encodeURIComponent(s), _ = encodeURIComponent(`${l} ${s}`);
  return /* @__PURE__ */ e.jsxs(C, { ...v, children: [
    ...
    /* @__PURE__ */ e.jsxs(z, { className: "max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8", children: [
      /* @__PURE__ */ e.jsx("div", { className: "sticky top-0 ml-auto size-0", children: /* @__PURE__ */ e.jsx(a, { className: "absolute -top-5 -right-5 cursor-pointer p-2 text-muted-foreground hover:text-foreground [&_svg]:size-6!", size: "lg", variant: "link", onClick: o, children: /* @__PURE__ */ e.jsx(M, { size: 24, strokeWidth: 1 }) }) }),
      /* @__PURE__ */ e.jsxs(H, { className: "relative -mt-5", children: [
        /* @__PURE__ */ e.jsxs($, { className: "text-3xl leading-[1.15em] font-bold", children: [
          /* @__PURE__ */ e.jsx("span", { className: "text-green-500", children: m }),
          /* @__PURE__ */ e.jsx("br", {}),
          /* @__PURE__ */ e.jsx("span", { children: p })
        ] }),
        t && /* @__PURE__ */ e.jsx(P, { className: "mb-0 pt-1 pb-0 text-lg text-foreground", children: t })
      ] }),
      ...
      /* @__PURE__ */ e.jsx(D, { className: "justify-between gap-6", children: x ? /* @__PURE__ */ e.jsx(a, { className: "cursor-pointer", type: "submit", onClick: o, children: "Close" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { "aria-label": "Share on Threads", className: "flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://threads.net/intent/post?text=${_}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 18 18", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { "aria-label": "Share on Facebook", className: "flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://www.facebook.com/sharer/sharer.php?u=${r}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 40 40", children: [
...
//# sourceMappingURL=post-share-modal-DWe35McY.mjs.map
