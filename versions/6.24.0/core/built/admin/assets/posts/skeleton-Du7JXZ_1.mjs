import { R as g, j as s, B as ee, A as te, D as P, b as U, q as k, u as G, o as N, a as oe, n as B } from "./index-By5yPnMZ.mjs";
import { d as q, h as j, m as L, e as ne, P as V, f as E, b as re, u as se } from "./heading-DXxLDQ96.mjs";
function ce(e) {
  const t = e + "CollectionProvider", [c, n] = q(t), [b, m] = c(
    t,
    { collectionRef: { current: null }, itemMap: /* @__PURE__ */ new Map() }
  ), l = (p) => {
    const { scope: o, children: u } = p, v = g.useRef(null), a = g.useRef(/* @__PURE__ */ new Map()).current;
  ...
  f.displayName = x;
  const r = e + "CollectionItemSlot", I = "data-radix-collection-item", C = L(r), R = g.forwardRef(
    (p, o) => {
      const { scope: u, children: v, ...a } = p, i = g.useRef(null), T = j(o, i), w = m(r, u);
      return g.useEffect(() => (w.itemMap.set(i, { ref: i, ...a }), () => void w.itemMap.delete(i))), /* @__PURE__ */ s.jsx(C, { [I]: "", ref: T, children: v });
    }
  );
  R.displayName = r;
  function S(p) {
...
var pe = P((e, t) => {
  const {
    ...
    onChange: h,
    caller: y
  }), [u, v] = G(!1), a = se(f), i = Y(c), T = k(!1), [w, A] = G(0);
  return U(() => {
    const d = C.current;
    if (d)
  ...
  (e, t) => {
    const {
      ...
      children: l,
      ...x
    } = e, h = ne(), f = m || h, r = me(H, c), I = r.currentTabStopId === f, C = Y(c), { onFocusableItemAdd: R, onFocusableItemRemove: S, currentTabStopId: p } = r;
    return U(() => {
      if (n)
        return R(), () => S();
...
//# sourceMappingURL=skeleton-Du7JXZ_1.mjs.map
