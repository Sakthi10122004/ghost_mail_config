import { D as h, j as e, R as g, T as J, n as w, A as K, B as W, Z as S, q as X, e as Y, _ as ee } from "./index-By5yPnMZ.mjs";
import { b as G, P as T, f as se, d as ae, B as b } from "./heading-DXxLDQ96.mjs";
import { c as E, I as te, u as re, R as le } from "./skeleton-Du7JXZ_1.mjs";
import { H as m, u as oe } from "./use-infinite-virtual-scroll-B_NwiBXK.mjs";
import { M as ne } from "./main-layout-CGs25JVH.mjs";
import { T as ie, a as ce, b as P, c as j, d as de, e as f } from "./table-DlaJMBps.mjs";
import { P as ue, T as ge } from "./tags-CLyaNf39.mjs";
import { E as pe } from "./empty-indicator-DTmBQa_3.mjs";
import { L as xe } from "./loading-indicator-CSj2spwS.mjs";
import { d as me } from "./hooks-pVotzebr.mjs";
var $ = "Toggle", C = h((s, t) => {
...
const Q = J(
  "inline-flex items-center justify-center gap-2 rounded-xs text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 hover:text-foreground focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50 data-[state=on]:bg-background data-[state=on]:text-foreground data-[state=on]:shadow-sm dark:hover:bg-background [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:stroke-[1.5px]",
  {
    variants: {
      variant: {
...
//# sourceMappingURL=tags-CjwolIiT.mjs.map
