import { D as i, j as t, W as x, n as o, T as f } from "./index-By5yPnMZ.mjs";
import { R as h, f as g, b as u, d, e as b, X as y, T as n, D as l, O as r } from "./dialog-67vvNv8e.mjs";
...
const j = f(
  ...
  /* @__PURE__ */ t.jsxs(
    d,
    {
      ...
      ...m,
      children: [
        /* @__PURE__ */ t.jsxs(b, { className: "fixed top-4 right-4 z-50 rounded-xs opacity-70 ring-offset-background transition-opacity hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-secondary", children: [
...
//# sourceMappingURL=sheet-SOdCzxUt.mjs.map
