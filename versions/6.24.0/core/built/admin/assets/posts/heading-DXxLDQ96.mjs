import { o as A, A as _, a as b, j as l, B as L, U as F, q as C, b as P, u as O, E as N, D as p, F as y, G as g, H as j, J as W, a5 as V, v as $, n as v, T as U } from "./index-By5yPnMZ.mjs";
function I(t, e) {
...
const xt = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], bt = vt("chevron-down", xt), ht = U(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, children: r, ...s }, c) => {
    const i = o ? it : "button", a = e === "dropdown" ? /* @__PURE__ */ l.jsxs(l.Fragment, { children: [
      r,
      /* @__PURE__ */ l.jsx(bt, { className: "-mr-0.5! -ml-1! size-4 stroke-[2px]! opacity-50", strokeWidth: 2 })
    ] }) : r;
...
//# sourceMappingURL=heading-DXxLDQ96.mjs.map
