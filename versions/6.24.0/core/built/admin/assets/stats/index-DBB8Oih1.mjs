import { c as we, f as F, j as e, S as ye, a as _, u as ie, b as J, d as E, e as H, g as ne, h as x, i as Z, k as q, R as ke, l as ee, m as se, n as L, o as _e, p as D, s as G, A as Ce } from "./index-DErXBfDM.mjs";
import { B as A, X as ze, H as le, C as Ae, L as Te, a as I, b as V, c as B, d as O, e as U, S as y, f as Me, P as Le, g as Ee, G as R, U as oe, M as P, h as $e, E as S, F as ce, i as We, j as De, k as Y, l as Re, m as X, K as Fe, n as He, o as Ie, p as Ve, I as Be, q as Oe, r as ae, s as re, t as Ue, u as Ge, v as Ye, w as Ke, x as Qe, y as qe, z as Pe, N as Xe, D as Je, A as Se, J as Ze } from "./stats-BeJgKX2G.mjs";
import { R as es, T as ss, P as as, C as de, a as me, D as ue, O as he, g as xe, b as rs } from "./audience-BiHYBUzT.mjs";
import { u as ts } from "./use-growth-stats-WMYXBQE3.mjs";
...
const ps = ({
  ...
  return /* @__PURE__ */ e.jsxs(us, { ...f, children: [
    ...
    /* @__PURE__ */ e.jsxs(fe, { className: "max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8", children: [
      /* @__PURE__ */ e.jsx("div", { className: "sticky top-0 ml-auto size-0", children: /* @__PURE__ */ e.jsx(A, { className: "absolute -top-5 -right-5 cursor-pointer p-2 text-muted-foreground hover:text-foreground [&_svg]:size-6!", size: "lg", variant: "link", onClick: g, children: /* @__PURE__ */ e.jsx(ze, { size: 24, strokeWidth: 1 }) }) }),
      ...
      /* @__PURE__ */ e.jsxs("a", { className: "flex flex-col items-stretch overflow-hidden rounded-md border transition-all hover:border-muted-foreground/40", href: r, rel: "noopener noreferrer", target: "_blank", children: [
  ...
  return /* @__PURE__ */ e.jsxs(I, { className: "group/card w-full lg:col-span-2", "data-testid": "top-posts-card", children: [
    ...
    /* @__PURE__ */ e.jsx(U, { children: r ? /* @__PURE__ */ e.jsx(Oe, { className: "mt-6" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
      (f = s == null ? void 0 : s.stats) == null ? void 0 : f.map((t) => /* @__PURE__ */ e.jsxs("div", { className: 'group relative flex w-full items-start justify-between gap-5 border-t border-border/50 py-4 before:absolute before:-inset-x-4 before:inset-y-0 before:z-0 before:hidden before:rounded-md before:bg-accent before:opacity-80 before:content-[""] first:border-border! hover:cursor-pointer hover:border-transparent hover:before:block md:items-center dark:before:bg-accent/50 [&+div]:hover:border-transparent', children: [
        /* @__PURE__ */ e.jsxs("div", { className: "z-10 flex min-w-[160px] grow items-start gap-4 md:items-center lg:min-w-[320px]", onClick: () => {
          ...
          t.feature_image ? /* @__PURE__ */ e.jsx("div", { className: "hidden aspect-[16/10] w-[80px] shrink-0 rounded-sm bg-cover bg-center sm:visible! sm:block! lg:w-[100px]", style: {
          ...
          /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ e.jsx("span", { className: "line-clamp-2 text-lg leading-[1.35em] font-semibold", children: t.title }),
...
//# sourceMappingURL=index-DBB8Oih1.mjs.map
